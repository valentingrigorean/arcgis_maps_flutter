...
Map<String, T> keyByMapsObjectId<T extends MapsObject>(Iterable<T> objects) {
  return Map<String, T>.fromEntries(objects
      .map((T object) => MapEntry<String, T>(object.mapsId, object.clone())));
}
