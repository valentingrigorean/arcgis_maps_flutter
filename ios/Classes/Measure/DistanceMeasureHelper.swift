...
class DistanceMeasureHelperImpl: ArcGisMeasureHelper {
    ...
    private let centerMarker = AGSSimpleMarkerSymbol(style: .cross, color: UIColor(red: 156, green: 39, blue: 176, alpha: 1), size: 10)
    ...
    private func drawPolyline(points: [AGSPoint]) -> Double {
        ...
        let polylineSymbol = AGSSimpleLineSymbol(style: .solid, color: .blue, width: 3)
