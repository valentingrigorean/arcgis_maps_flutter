...
class AGSOfflineMapSyncJobNativeObject: BaseNativeObject<AGSOfflineMapSyncJob> {
    init(objectId: String, job: AGSOfflineMapSyncJob, messageSink: NativeObjectControllerMessageSink) {
