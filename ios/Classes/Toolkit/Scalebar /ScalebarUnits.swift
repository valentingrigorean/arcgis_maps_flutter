...
public enum ScalebarUnits {
    ...
    /// Nautical units (nautical miles, etc)
    case nauticalMiles
    ...
    var baseLinearUnit: LinearUnit {
        self == .imperial ? LinearUnit.feet : LinearUnit.meters
    }
    ...
    private static func multiplier(forDistance distance: Double) -> Double {
        ...
        let multiplier = ScalebarUnits.roundNumberMultipliers.filter {
                    $0 <= residual
                }
                .last ?? 0
        return multiplier
